...
{
	if (region.ac.F === region.aq.F)
	{
		return 'on line ' + region.ac.F;
	}
	return 'on lines ' + region.ac.F + ' through ' + region.aq.F;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bi: 'hidden', E: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bi: 'mozHidden', E: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bi: 'msHidden', E: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bi: 'webkitHidden', E: 'webkitvisibilitychange' }
		: { bi: 'hidden', E: 'visibilitychange' };
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.bu, request.ah, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail($elm$http$Http$BadUrl(request.ah)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		ah: xhr.responseURL,
		bG: { a9: xhr.status, n: xhr.statusText },
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {av: fragment, ay: host, aH: path, aJ: port_, aN: protocol, aO: query};
	});
...
var $author$project$Ajourhold$Types$MainUrl = $elm$core$Basics$identity;
...
var $author$project$Common$ModalDialog$DialogHidden = {$: 0};
var $author$project$Ajourhold$Update$initModel = F3(
	function (mainUrl, ajcat, lang) {
		return {M: ajcat, r: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, bf: $author$project$Common$ModalDialog$DialogHidden, U: $elm$core$Maybe$Nothing, bj: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, bl: $elm$core$Maybe$Nothing, aD: lang, bs: mainUrl, N: $elm$core$Maybe$Nothing, Z: _List_Nil, aT: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, O: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing, bJ: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, bM: $elm$core$Maybe$Nothing, bO: '-1', a$: '0', a1: $elm$core$Maybe$Nothing, bR: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing, aj: $elm$core$Maybe$Nothing, bU: $elm$core$Maybe$Nothing};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Ajourhold$AjourCatEnum$AceAbsence = 3;
var $author$project$Ajourhold$AjourCatEnum$AceEmergency = 1;
var $author$project$Ajourhold$AjourCatEnum$AceExtra = 4;
var $author$project$Ajourhold$AjourCatEnum$AceGeneralAddition = 7;
var $author$project$Ajourhold$AjourCatEnum$AceNone = 8;
var $author$project$Ajourhold$AjourCatEnum$AceSlide = 5;
var $author$project$Ajourhold$AjourCatEnum$AceSwap = 2;
var $author$project$Ajourhold$AjourCatEnum$AceTimeoff = 0;
var $author$project$Ajourhold$AjourCatEnum$AceVacation = 6;
...
var $author$project$Ajourhold$Requests$init = function (flags) {
	...
	return _Utils_Tuple2(
		A3(
			...
			flags.aE,
			$author$project$Ajourhold$AjourCatEnum$toEnum(flags.M),
			lang),
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Ajourhold$Types$InitDataCurDayFetched = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Ajourhold$Types$InitDataCurDay = F9(
	function (userId, curUnitId, curWatchid, curDate, curHbank, watches, watchDefs, workPlaces, reasonCodes) {
		return {bb: curDate, bc: curHbank, bd: curUnitId, be: curWatchid, Z: reasonCodes, bO: userId, a1: watchDefs, ai: watches, aj: workPlaces};
	});
...
var $author$project$Ajourhold$Types$WatchDef = F6(
	function (len, hourFrom, hourTo, reason, isExtra, startDate) {
		return {U: hourFrom, bk: hourTo, bq: isExtra, br: len, bD: reason, ad: startDate};
	});
...
var $author$project$Ajourhold$Decoders$myInitDataCurDayDecoder = function () {
	var myDecoder = A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'reasonCodes',
...
var $author$project$Ajourhold$Types$InitData = F5(
	function (userId, workPlaces, saldo, vacation, reasonCodes) {
		return {Z: reasonCodes, aT: saldo, bO: userId, a$: vacation, aj: workPlaces};
	});
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Ajourhold$Requests$initDataCurDayFetched(
				A2($elm$core$Basics$composeR, $author$project$Ajourhold$Decoders$myInitDataCurDayDecoder, $author$project$Ajourhold$Types$InitDataCurDayFetched))
			]));
};
...
var $author$project$Common$ModalDialog$Error = 2;
var $author$project$Common$ModalDialog$Info = 0;
...
var $author$project$Common$ModalDialog$errorAlert = F4(
	function (title, errMsg, httpErr, model) {
		...
		return _Utils_update(
			model,
			{
				bf: A3($author$project$Common$ModalDialog$DialogVisibleAlert, title_, errStr, 2)
			});
	});
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bn: index, bt: match, by: number, bH: submatches};
	});
...
var $author$project$Ajourhold$Update$resetModel = F2(
	function (model, dlgState) {
		var newModel = A3($author$project$Ajourhold$Update$initModel, model.bs, model.M, model.aD);
		return _Utils_update(
			newModel,
			{bf: dlgState, Z: model.Z, aT: model.aT, bO: model.bO, aj: model.aj, bU: model.bU});
	});
...
var $author$project$Ajourhold$Commands$ajCatDateFrom = function (model) {
	if (model.M === 1) {
		...
		if (!_v0.$) {
			var selWatch = _v0.a;
			var wd = A2($author$project$Ajourhold$Commands$getWatchDef, selWatch, model.a1);
			if (!_Utils_eq(wd.ad, model.r)) {
				var mhf = A2($elm$core$Maybe$withDefault, '00:00', model.U);
				var cmp = A2($author$project$Common$DateTimeUtil$hourStrCompare, wd.U, mhf);
				return (cmp === 1) ? $author$project$Ajourhold$Commands$toJsonString(wd.ad) : $author$project$Ajourhold$Commands$toJsonString(model.r);
			} else {
				return $author$project$Ajourhold$Commands$toJsonString(wd.ad);
			}
		} else {
			return $elm$json$Json$Encode$null;
		}
	} else {
		return $author$project$Ajourhold$Commands$toJsonString(model.r);
	}
};
...
var $author$project$Ajourhold$Commands$isExtra = function (model) {
	...
	if (_v0.$ === 1) {
		...
		var w = _v0.a;
		var curWd = A2($author$project$Ajourhold$Commands$getWatchDef, w, model.a1);
		return $elm$core$Maybe$Just(curWd.bq);
	}
};
...
var $elm$http$Http$expectJson = function (decoder) {
	return $elm$http$Http$expectStringResponse(
		function (response) {
			var _v0 = A2($elm$json$Json$Decode$decodeString, decoder, response.a4);
			if (_v0.$ === 1) {
...
var $author$project$Ajourhold$Commands$sendData = function (model) {
	...
	var stem = _List_fromArray(
		[
			_Utils_Tuple2(
			'userId',
			$elm$json$Json$Encode$string(model.bO)),
			_Utils_Tuple2(
			'msgType',
			$elm$json$Json$Encode$int(
				$author$project$Ajourhold$AjourCatEnum$fromEnum(model.M))),
			_Utils_Tuple2(
			'workPlace',
			$author$project$Ajourhold$Commands$toJsonInt(model.O)),
			_Utils_Tuple2(
			'dateFrom',
			...
			_Utils_Tuple2(
			'reason',
			$author$project$Ajourhold$Commands$toJsonInt(model._)),
			_Utils_Tuple2(
			'timeBank',
			$author$project$Ajourhold$Commands$toJsonFloat(model.bM)),
			_Utils_Tuple2(
			'msg',
			$author$project$Ajourhold$Commands$toJsonString(model.N)),
			_Utils_Tuple2(
			'isExtra',
		...
		switch (ajCat) {
			case 2:
				return A2(
					...
					_Utils_Tuple2(
						'turnuslinjeId',
						$author$project$Ajourhold$Commands$toJsonInt(model.p)),
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
							'turnuslinjeId2',
							$author$project$Ajourhold$Commands$toJsonInt(model.aa)),
						A2(
							$elm$core$List$cons,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_Utils_Tuple2(
									'hourFrom2',
									$author$project$Ajourhold$Commands$toJsonString(model.bj)),
								A2(
									$elm$core$List$cons,
									_Utils_Tuple2(
										'hourTo2',
										$author$project$Ajourhold$Commands$toJsonString(model.bl)),
									stem)))));
			default:
				return A2(
					$elm$core$List$cons,
...
var $author$project$Ajourhold$Types$UserId = $elm$core$Basics$identity;
var $author$project$Ajourhold$Types$CoverFor = {$: 2};
...
var $author$project$Ajourhold$Types$WatchInfo = F2(
	function (watches, watchDefs) {
		return {a1: watchDefs, ai: watches};
	});
...
var $author$project$Ajourhold$Types$NoWorkPlace = {$: 1};
var $author$project$Ajourhold$Types$TimebankFetched = function (a) {
	return {$: 4, a: a};
};
var $author$project$Ajourhold$Types$Watch1 = {$: 0};
...
var $author$project$Ajourhold$Update$updateCoverFor = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var s = msg.a;
				var w = A2($author$project$Ajourhold$Commands$getWatchDef, s, model.a1);
				var sumStr = A2($author$project$Common$Misc$formatNumberStr, w.br, 2);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							U: $elm$core$Maybe$Just(w.U),
							bk: $elm$core$Maybe$Just(w.bk),
							_: $elm$core$Maybe$Just(w.bD),
							p: $elm$core$Maybe$Just(s),
							bJ: $elm$core$Maybe$Just(sumStr)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var s = msg.b;
				var myDateFrom = $author$project$Ajourhold$Update$maybeDate(s);
				var curCmd = A5($author$project$Ajourhold$Commands$fetchCoverFor, model.bs, model.bO, model.O, myDateFrom, model.ao);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{r: myDateFrom, U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing}),
					curCmd);
			case 2:
				var s = msg.a;
				...
				var curCmd = function () {
					if (s === '-1') {
						...
						var curWp = $author$project$Ajourhold$Types$toWorkPlace(model.O);
						return $elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A5($author$project$Ajourhold$Commands$fetchCoverFor, model.bs, model.bO, wp, model.r, model.ao),
									A4($author$project$Ajourhold$Commands$fetchTimebankWorkPlace, model.bs, model.bO, curWp, newWp)
								]));
					}
				}();
				var newModel = (s === '-1') ? _Utils_update(
					model,
					{U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing, O: wp, bJ: $elm$core$Maybe$Nothing, a1: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing}) : _Utils_update(
					model,
					{U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing, O: wp, bJ: $elm$core$Maybe$Nothing, a1: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing});
		...
		switch (msg.$) {
			...
			case 1:
				...
				var curModel = _Utils_update(
					model,
					{r: myDateFrom, U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing});
				var curCmd = A6($author$project$Ajourhold$Commands$fetchWatches, model.bs, 1, model.bO, model.O, myDateFrom, model.ao);
			...
			case 2:
				...
				var newWp = $author$project$Ajourhold$Types$toWorkPlace(wp);
				var curWp = $author$project$Ajourhold$Types$toWorkPlace(model.O);
				var curCmd = (s === '-1') ? $elm$core$Platform$Cmd$none : ($author$project$Ajourhold$Commands$isDateFromLess(model) ? A4($author$project$Ajourhold$Commands$fetchTimebankWorkPlace, model.bs, model.bO, curWp, newWp) : $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A6($author$project$Ajourhold$Commands$fetchWatches, model.bs, model.M, model.bO, wp, model.r, model.ao),
							A4($author$project$Ajourhold$Commands$fetchTimebankWorkPlace, model.bs, model.bO, curWp, newWp)
						])));
				var newModel = (s === '-1') ? _Utils_update(
					model,
					{U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing, O: wp, bJ: $elm$core$Maybe$Nothing, a1: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing}) : _Utils_update(
					model,
					{U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing, O: wp, bJ: $elm$core$Maybe$Nothing, a1: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing});
				return _Utils_Tuple2(newModel, curCmd);
			case 3:
				if (!msg.a.$) {
					var s = msg.a.a;
...
var $author$project$Ajourhold$Types$NoDate = {$: 1};
		...
		switch (msg.$) {
			case 0:
				...
				var newModel = (index === 1) ? _Utils_update(
					model,
					{
						r: $elm$core$Maybe$Just(s)
					}) : _Utils_update(
					model,
					{
						ao: $elm$core$Maybe$Just(s)
					});
				var curWp = $author$project$Ajourhold$Types$toWorkPlace(model.O);
				var curFromDate = $author$project$Ajourhold$Types$toMyDate(model.r);
				var curDate = $author$project$Ajourhold$Types$toMyDate(
					$elm$core$Maybe$Just(s));
				var slideFn = (index === 1) ? A4($author$project$Ajourhold$Commands$fetchSlideFrom, model.bs, usr, curWp, curDate) : A6($author$project$Ajourhold$Commands$fetchSlideTo, model.bs, usr, curWp, model.p, curFromDate, curDate);
				return _Utils_Tuple2(newModel, slideFn);
			case 1:
				var index = msg.a;
				var s = msg.b;
				var w = (index === 1) ? A2($author$project$Ajourhold$Commands$getWatchDef, s, model.a1) : A2($author$project$Ajourhold$Commands$getWatchDef, s, model.bR);
				var sumStr = A2($author$project$Common$Misc$formatNumberStr, w.br, 2);
				var newModel = (index === 1) ? _Utils_update(
					model,
					{
					...
					model,
					{
						bj: $elm$core$Maybe$Just(w.U),
						bl: $elm$core$Maybe$Just(w.bk),
						aa: $elm$core$Maybe$Just(s),
						bK: $elm$core$Maybe$Just(sumStr)
					});
			...
			case 2:
				...
				var newModel = (index === 1) ? _Utils_update(
					...
					model,
					{
						...
						bF: $elm$core$Maybe$Just(s)
					});
				var curWp = $author$project$Ajourhold$Types$toWorkPlace(
					$elm$core$Maybe$Just(s));
				var curFromDate = $author$project$Ajourhold$Types$toMyDate(model.r);
				var curDate = (index === 1) ? $author$project$Ajourhold$Types$toMyDate(model.r) : $author$project$Ajourhold$Types$toMyDate(model.ao);
				var slideFn = (index === 1) ? A4($author$project$Ajourhold$Commands$fetchSlideFrom, model.bs, usr, curWp, curDate) : A6($author$project$Ajourhold$Commands$fetchSlideTo, model.bs, usr, curWp, model.p, curFromDate, curDate);
				return _Utils_Tuple2(newModel, slideFn);
			default:
				if (!msg.b.$) {
					...
					var newModel = (index === 1) ? _Utils_update(
						model,
						{p: $elm$core$Maybe$Nothing, a1: s.a1, ai: s.ai}) : _Utils_update(
						model,
						{aa: $elm$core$Maybe$Nothing, bR: s.a1, bS: s.ai});
					return _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
				} else {
					var err = msg.b.a;
					return _Utils_Tuple2(
...
var $author$project$Ajourhold$Update$updateSwap = F3(
	function (index, msg, model) {
		switch (msg.$) {
			...
			case 1:
				var s = msg.b;
				var wp = (index === 1) ? model.O : model.bF;
				var newDate = $author$project$Ajourhold$Update$maybeDate(s);
				var updMod = (index === 1) ? _Utils_update(
					model,
					{r: newDate, p: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing}) : _Utils_update(
					model,
					{ao: newDate, aa: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing});
				var curCmd = (s === '-1') ? $elm$core$Platform$Cmd$none : ((index === 1) ? A4($author$project$Ajourhold$Commands$fetchWatchesSwapFrom, updMod.bs, updMod.bO, wp, newDate) : A6($author$project$Ajourhold$Commands$fetchWatchesSwapTo, updMod.bs, updMod.bO, wp, updMod.r, newDate, model.p));
			...
			case 2:
				...
				var updMod = (index === 1) ? _Utils_update(
					model,
					{p: $elm$core$Maybe$Nothing, O: wp, ai: $elm$core$Maybe$Nothing}) : _Utils_update(
					model,
					{aa: $elm$core$Maybe$Nothing, bF: wp, bS: $elm$core$Maybe$Nothing});
				var curCmd = (s === '-1') ? $elm$core$Platform$Cmd$none : ((index === 1) ? A4($author$project$Ajourhold$Commands$fetchWatchesSwapFrom, updMod.bs, updMod.bO, wp, updMod.r) : A6($author$project$Ajourhold$Commands$fetchWatchesSwapTo, updMod.bs, updMod.bO, wp, updMod.r, updMod.ao, updMod.p));
				return _Utils_Tuple2(updMod, curCmd);
			case 3:
				if (!msg.a.$) {
					var s = msg.a.a;
		...
		switch (msg.$) {
			...
			case 1:
				...
				var curModel = (index === 1) ? _Utils_update(
					model,
					{r: myDateFrom, U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing}) : _Utils_update(
					model,
					{ao: myDateFrom, U: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, p: $elm$core$Maybe$Nothing});
				var curCmd = A6($author$project$Ajourhold$Commands$fetchWatches, model.bs, model.M, model.bO, model.O, myDateFrom, model.ao);
				return _Utils_Tuple2(curModel, curCmd);
			case 2:
				var s = msg.a;
				var wp = $elm$core$Maybe$Just(s);
			...
			default:
				if (!msg.a.$) {
					...
					var mySaldo = $elm$core$String$fromFloat(
						A2($author$project$Common$Misc$toDecimal, s.bP, 100.0));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aT: $elm$core$Maybe$Just(mySaldo)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var s = msg.a.a;
...
var $author$project$Ajourhold$Types$Watch2 = {$: 1};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var s = msg.a;
				var wp = $elm$core$Maybe$Just(s);
				var curCmd = (s === '-1') ? $elm$core$Platform$Cmd$none : A5($author$project$Ajourhold$Commands$fetchWatches2, model.bs, model.bO, wp, model.r, model.ao);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aa: $elm$core$Maybe$Nothing, bF: wp, bS: $elm$core$Maybe$Nothing}),
		...
		switch (msg.$) {
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bf: $author$project$Common$ModalDialog$DialogHidden}),
					$elm$core$Platform$Cmd$none);
			case 2:
				if (!msg.a.$) {
					var s = msg.a.a;
			...
			case 3:
				if (!msg.a.$) {
					var s = msg.a.a;
					var w = A2(
						$author$project$Ajourhold$Commands$getWatchDef,
						s.be,
						$elm$core$Maybe$Just(s.a1));
					var sumStr = A2($author$project$Common$Misc$formatNumberStr, w.br, 2);
					var selWorkPlace = (s.bd === '-1') ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(s.bd);
					var selWatch = (s.be === '-1') ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(s.be);
					var mySaldo = $elm$core$String$fromFloat(
						A2($author$project$Common$Misc$toDecimal, s.bc.bP, 100.0));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								r: $elm$core$Maybe$Just(s.bb),
								U: $elm$core$Maybe$Just(w.U),
								bk: $elm$core$Maybe$Just(w.bk),
								Z: s.Z,
								aT: $elm$core$Maybe$Just(mySaldo),
								...
								bJ: $elm$core$Maybe$Just(sumStr),
								bO: s.bO,
								a1: $elm$core$Maybe$Just(s.a1),
								ai: $elm$core$Maybe$Just(s.ai),
								aj: $elm$core$Maybe$Just(s.aj)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
						...
						_Utils_update(
							model,
							{
								bf: A3(
									$author$project$Common$ModalDialog$DialogVisibleAlert,
									'Subscriptions',
									'InitDataCurDayFetched Error: ' + $elm$json$Json$Decode$errorToString(s),
									2)
							}),
						$elm$core$Platform$Cmd$none);
				}
			...
			case 1:
				if (!msg.a.$) {
					var s = msg.a.a;
					var mySaldo = $elm$core$String$fromFloat(
						A2($author$project$Common$Misc$toDecimal, s.aT, 100.0));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
					...
					switch (index) {
						case 1:
							...
							return _Utils_update(
								model,
								{
									...
									p: $elm$core$Maybe$Nothing,
									bJ: $elm$core$Maybe$Just(curSumHours)
								});
						case 2:
							var curSumHours = A2(
								$author$project$Ajourhold$Update$calcSumHours,
						...
						case 21:
							...
							return _Utils_update(
								model,
								{
									bj: $elm$core$Maybe$Just(s),
									aa: $elm$core$Maybe$Nothing,
									bK: $elm$core$Maybe$Just(curSumHours)
								});
						case 31:
							var curSumHours = A2(
								$author$project$Ajourhold$Update$calcSumHours,
				...
				if (!sendMsg.$) {
					...
					if (!sendMsg.a.$) {
						...
						var dialogState = function () {
							if (s.bz) {
								var title = A2($author$project$Common$Misc$getLangValue, 'data_sent_ok', model.aD);
								return A3($author$project$Common$ModalDialog$DialogVisibleAlert, title, s.bv, 0);
							} else {
								var title = A2($author$project$Common$Misc$getLangValue, 'data_sent_err', model.aD);
								return A3($author$project$Common$ModalDialog$DialogVisibleAlert, title, s.bv, 2);
							}
						}();
...
var $author$project$Ajourhold$Types$AlertOk = {$: 0};
...
var $author$project$Ajourhold$Types$IsDisabled = $elm$core$Basics$identity;
...
var $author$project$Ajourhold$Types$Send = {$: 0};
var $author$project$Common$Buttons$Success = 0;
...
var $author$project$Ajourhold$Commands$canSendData2 = function (m) {
	return (!_Utils_eq(m.r, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.O, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m._, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.p, $elm$core$Maybe$Nothing)) && (!_Utils_eq(m.N, $elm$core$Maybe$Nothing)))));
};
var $author$project$Ajourhold$Commands$canSendData3 = function (m) {
	return (!_Utils_eq(m.r, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.O, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.p, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.bF, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.aa, $elm$core$Maybe$Nothing)) && (!_Utils_eq(m.N, $elm$core$Maybe$Nothing))))));
};
var $author$project$Ajourhold$Commands$canSendData_ = function (m) {
	return (!_Utils_eq(m.r, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m.O, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(m._, $elm$core$Maybe$Nothing)) && (!_Utils_eq(m.N, $elm$core$Maybe$Nothing))));
};
...
var $author$project$Ajourhold$Views$ViewItems$btn = F2(
	function (model, _v0) {
		var gpos = _v0;
		var title = A2($author$project$Common$Misc$getLangValue, 'lagre', model.aD);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Ajourhold$Views$ViewItems$dateItem2 = F4(
	function (title, value, event, checkMissing) {
		var value_ = A2($elm$core$Maybe$withDefault, '', value);
		var isMissing = _Utils_eq(value, $elm$core$Maybe$Nothing);
		var myClazz = checkMissing ? (isMissing ? 'missing' : '') : '';
...
var $author$project$Ajourhold$Views$ViewItems$dateItem = F3(
	function (title, value, event) {
		return A4($author$project$Ajourhold$Views$ViewItems$dateItem2, title, value, event, true);
	});
var $author$project$Ajourhold$Types$GridPosition = $elm$core$Basics$identity;
var $author$project$Ajourhold$Views$ViewItems$gA1 = 'grid-ajour-a1';
...
var $author$project$Ajourhold$Views$ViewItems$dateFrom = F2(
	function (model, msg) {
		var title = A2($author$project$Common$Misc$getLangValue, 'fra_dato', model.aD);
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			$author$project$Ajourhold$Views$ViewItems$gA1,
			A3($author$project$Ajourhold$Views$ViewItems$dateItem, title, model.r, msg));
	});
var $author$project$Ajourhold$Views$ViewItems$dateTo2 = F4(
	function (model, msg, gpos, checkMissing) {
		var title = A2($author$project$Common$Misc$getLangValue, 'til_dato', model.aD);
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A4($author$project$Ajourhold$Views$ViewItems$dateItem2, title, model.ao, msg, checkMissing));
	});
...
var $author$project$Ajourhold$Views$ViewItems$fromHour = F3(
	function (model, _v0, gpos) {
		var isDisabled = _v0;
		var title = A2($author$project$Common$Misc$getLangValue, 'fra_kl', model.aD);
		var index = (model.M === 1) ? 31 : 1;
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A4(
...
var $author$project$Ajourhold$Views$ViewItems$gA2 = 'grid-ajour-a2';
var $author$project$Ajourhold$Views$ViewItems$gB1 = 'grid-ajour-b1';
var $author$project$Ajourhold$Views$ViewItems$gB2 = 'grid-ajour-b2';
var $author$project$Ajourhold$Views$ViewItems$gC1 = 'grid-ajour-c1';
var $author$project$Ajourhold$Views$ViewItems$gC2 = 'grid-ajour-c2';
var $author$project$Ajourhold$Views$ViewItems$gC3 = 'grid-ajour-c3';
var $author$project$Ajourhold$Views$ViewItems$gE1 = 'grid-ajour-e1';
var $author$project$Ajourhold$Views$ViewItems$gE23 = 'grid-ajour-e23';
var $author$project$Ajourhold$Views$ViewItems$gF1 = 'grid-ajour-f1';
var $author$project$Ajourhold$Views$ViewItems$gD2 = 'grid-ajour-d2';
var $author$project$Ajourhold$Views$ViewItems$hourBankBalance = function (model) {
	var title = A2($author$project$Common$Misc$getLangValue, 'timebank_saldo', model.aD);
	var mySaldo = A2($elm$core$Maybe$withDefault, '0.00', model.aT);
...
var $author$project$Ajourhold$Views$ViewItems$message = F2(
	function (model, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'melding', model.aD);
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A2($author$project$Ajourhold$Views$ViewItems$meldingInput, title, model.N));
	});
var $author$project$Ajourhold$Types$ReasonCodeChanged = function (a) {
	return {$: 4, a: a};
};
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$Ajourhold$Views$ViewItems$selectRow = F5(
	function (isMissing, isDisabled, title, mySelects, myMsg) {
		var mySelect = A2(
	...
	function (selected, item) {
		if (selected.$ === 1) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$value(item.P)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(item.ag)
					]));
		} else {
			var s = selected.a;
			return A2(
...
var $author$project$Ajourhold$Views$ViewItems$reasons = F2(
	function (model, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'aarsakskoder', model.aD);
		var rc = A3($author$project$Ajourhold$Views$ViewItems$wrapSelectItemsReasons, '-------', $elm$core$Maybe$Nothing, model.Z);
		var isMissingReason = _Utils_eq(model._, $elm$core$Maybe$Nothing);
...
var $author$project$Ajourhold$Views$ViewItems$sumHour = F2(
	function (model, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'timer', model.aD);
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A2($author$project$Ajourhold$Views$ViewItems$sumHourItem, title, model.bJ));
	});
var $author$project$Ajourhold$Views$ViewItems$toHour = F3(
	function (model, _v0, gpos) {
		var isDisabled = _v0;
		var title = A2($author$project$Common$Misc$getLangValue, 'til_kl', model.aD);
		var index = (model.M === 1) ? 32 : 2;
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A4(
...
var $author$project$Ajourhold$Views$ViewItems$watch1 = F4(
	function (model, isDisabled, msg, gpos) {
		var title = (model.M === 4) ? A2($author$project$Common$Misc$getLangValue, 'dekke_for', model.aD) : A2($author$project$Common$Misc$getLangValue, 'vakt', model.aD);
		var py = A3($author$project$Ajourhold$Views$ViewItems$wrapSelectItems, '-------', model.p, model.ai);
...
var $author$project$Ajourhold$Views$ViewItems$workPlace1 = F3(
	function (model, msg, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'arbeidssted', model.aD);
		var px = A3($author$project$Ajourhold$Views$ViewItems$wrapSelectItems, '-------', model.O, model.aj);
		var isMissing = _Utils_eq(model.O, $elm$core$Maybe$Nothing);
		var wp1 = A5($author$project$Ajourhold$Views$ViewItems$selectRow, isMissing, false, title, px, msg);
...
var $author$project$Ajourhold$Views$Absence$view = function (model) {
	...
	var isDisabled = (!_Utils_eq(model.ao, $elm$core$Maybe$Nothing)) || $author$project$Ajourhold$Commands$isDateFromLess(model);
	var watch1 = A4(
	...
	var date2 = A4(
		$author$project$Ajourhold$Views$ViewItems$dateTo2,
		model,
		A2(
			$elm$core$Basics$composeL,
			$author$project$Ajourhold$Types$WatchMsgFor($author$project$Ajourhold$Types$Watch1),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				watch1,
				workPlace1,
				A3($author$project$Ajourhold$Views$ViewItems$fromHour, model, false, $author$project$Ajourhold$Views$ViewItems$gC1),
				A3($author$project$Ajourhold$Views$ViewItems$toHour, model, false, $author$project$Ajourhold$Views$ViewItems$gC2),
				...
				A2($author$project$Common$ModalDialog$alert, model.bf, $author$project$Ajourhold$Types$AlertOk)
			]));
};
var $author$project$Ajourhold$Types$Emergency = {$: 4};
var $author$project$Ajourhold$Types$ToTimeBankChanged = function (a) {
	return {$: 9, a: a};
};
var $author$project$Ajourhold$Views$ViewItems$gD1 = 'grid-ajour-d1';
var $author$project$Ajourhold$Views$ViewItems$toHourBank = function (model) {
	var title = A2($author$project$Common$Misc$getLangValue, 'til_timebank', model.aD);
	var myToTimeBank = A2($elm$core$Maybe$withDefault, '0.00', model.bM);
...
var $author$project$Ajourhold$Views$ViewItems$gD23 = 'grid-ajour-d23';
var $author$project$Ajourhold$Views$GeneralAddition$view = function (model) {
	...
	var to_date_str = A2($author$project$Common$Misc$getLangValue, 'til_dato', model.aD);
	var from_date_str = A2($author$project$Common$Misc$getLangValue, 'fra_dato', model.aD);
	var date2 = A2(
		$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
		$author$project$Ajourhold$Views$ViewItems$gA2,
		A4(
			$author$project$Ajourhold$Views$ViewItems$dateItem2,
			to_date_str,
			model.ao,
...
var $author$project$Ajourhold$Views$ViewItems$dateTo = F3(
	function (model, msg, gpos) {
		return A4($author$project$Ajourhold$Views$ViewItems$dateTo2, model, msg, gpos, true);
	});
...
var $author$project$Ajourhold$Views$ViewItems$gA3 = 'grid-ajour-a3';
var $author$project$Ajourhold$Views$ViewItems$gB3 = 'grid-ajour-b3';
var $author$project$Ajourhold$Views$ViewItems$gD3 = 'grid-ajour-d3';
var $author$project$Ajourhold$Views$ViewItems$sumHour2 = F2(
	function (model, gpos) {
		...
		return A2(
			$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
			gpos,
			A2($author$project$Ajourhold$Views$ViewItems$sumHourItem, title, model.bK));
	});
...
var $author$project$Ajourhold$Views$ViewItems$watch2 = F4(
	function (model, isDisabled, msg, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'vakt', model.aD);
		var py = A3($author$project$Ajourhold$Views$ViewItems$wrapSelectItems, '-------', $elm$core$Maybe$Nothing, model.bS);
		var w2 = A5($author$project$Ajourhold$Views$ViewItems$selectRow, false, isDisabled, title, py, msg);
...
var $author$project$Ajourhold$Views$ViewItems$workPlace2 = F3(
	function (model, msg, gpos) {
		var title = A2($author$project$Common$Misc$getLangValue, 'arbeidssted', model.aD);
		var px = A3($author$project$Ajourhold$Views$ViewItems$wrapSelectItems, '-------', $elm$core$Maybe$Nothing, model.aj);
		var isMissing = _Utils_eq(model.O, $elm$core$Maybe$Nothing);
		var wp2 = A5($author$project$Ajourhold$Views$ViewItems$selectRow, isMissing, false, title, px, msg);
		return A2($author$project$Ajourhold$Views$ViewItems$gridAjourItem, gpos, wp2);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				workPlace1,
				watch1,
				A3($author$project$Ajourhold$Views$ViewItems$fromHour, model, true, $author$project$Ajourhold$Views$ViewItems$gB1),
				A3($author$project$Ajourhold$Views$ViewItems$toHour, model, true, $author$project$Ajourhold$Views$ViewItems$gB2),
				A2($author$project$Ajourhold$Views$ViewItems$sumHour, model, $author$project$Ajourhold$Views$ViewItems$gB3),
				date2,
				workPlace2,
				watch2,
				A3($author$project$Ajourhold$Views$ViewItems$fromHour2, model, false, $author$project$Ajourhold$Views$ViewItems$gD1),
				A3($author$project$Ajourhold$Views$ViewItems$toHour2, model, false, $author$project$Ajourhold$Views$ViewItems$gD2),
...
var $author$project$Ajourhold$Views$Vacation$view = function (model) {
	var workPlace1 = A3($author$project$Ajourhold$Views$ViewItems$workPlace1, model, $author$project$Ajourhold$Types$WorkPlaceChanged, $author$project$Ajourhold$Views$ViewItems$gB1);
	var vacationInput = A5($author$project$Ajourhold$Views$ViewItems$inputItem, 'string', model.a$, 'form-control', $elm$core$Maybe$Nothing, true);
	var to_date_str = A2($author$project$Common$Misc$getLangValue, 'til_dato', model.aD);
	var from_date_str = A2($author$project$Common$Misc$getLangValue, 'fra_dato', model.aD);
	var ferie_tilgode_str = A2($author$project$Common$Misc$getLangValue, 'ferie_tilgode', model.aD);
	var vacation = A2(
		$author$project$Ajourhold$Views$ViewItems$gridAjourItem,
		$author$project$Ajourhold$Views$ViewItems$gC1,
...
var $author$project$Ajourhold$Requests$main = $elm$browser$Browser$element(
	{bo: $author$project$Ajourhold$Requests$init, bI: $author$project$Ajourhold$Requests$subscriptions, bN: $author$project$Ajourhold$Update$update, bQ: $author$project$Ajourhold$View$view});
